...
- Designing module APIs: contracts, stability, and anti-corruption layers
- Enforcing boundaries in code (packaging, visibility, linting, tests, architecture rules)
- Managing shared code
- Transaction boundaries, consistency, and avoiding accidental distributed monoliths
- Intra-module communication patterns
- Refactoring strategies: strangler patterns, incrementality, and low-risk module extraction
- Hexagonal Architecture and Testing Strategies
- Preparing for future distribution
- Operational and delivery hygiene: build times, deployment pipelines, versioning
